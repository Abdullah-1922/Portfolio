"use client";
import UsedSkillsTag from "@/components/common/UsedSkillsTag";
import Image from "next/image";
import AOS from "aos";
import "aos/dist/aos.css";
import Link from "next/link";
import BlogDescriptionComponent from "../../blog/[id]/_components/BlogDescriptionComponent";

AOS.init();
const ProjectDetailsComponent = ({ project }: any) => {
  console.log(project);
  return (
    <div
      data-aos="fade-up"
    ...
    >
      <div className="mx-auto  px-4 py-4 sm:px-4 sm:py-5  lg:py-8">
        <div className="grid grid-cols-1 gap-5  ">
          <div className="relative h-[300px]  md:h-[450px] lg:h-[550px] xl:h-[600px] overflow-hidden rounded-lg  ">
            <Image
              width={1900}
              height={1000}
              alt="Project-1 Img"
          ...
          <div className="">
            <h2 className="md:text-5xl  card-title  font-bold text-4xl">
              {project.name}
            </h2>
            <p className="font-medium text-lg pt-2">
              Category :{" "}
              <span className="uppercase font-bold">{project.category}</span>
            </p>
            <div>
              <p className="text-xl py-5     font-semibold ">Technologies :</p>
            ...
            <div className="flex  pt-10 text-lg font-bold gap-10">
              <Link target="_blank" href={project?.githubLink}>
                <button className="flex items-center rounded border border-current px-8 text-sm font-medium text-indigo-600 transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:text-indigo-500">
                  GitHub
                  <svg
            ...
            <div className="py-5 card-title">
              <BlogDescriptionComponent content={project?.description} />
            </div>
          </div>
        </div>
      </div>
